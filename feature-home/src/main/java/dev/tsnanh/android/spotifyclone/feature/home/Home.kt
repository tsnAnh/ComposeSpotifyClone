...
import dev.tsnanh.android.spotifyclone.feature.home.components.RecentlyListenItem
import dev.tsnanh.android.spotifyclone.feature.home.components.SpotifyListItem
import dev.tsnanh.android.spotifyclone.feature.home.models.ArtistUiModel
import dev.tsnanh.android.spotifyclone.feature.home.models.HomeToolbarActions
...
private fun HomeContent(homeUiState: HomeUiState) {
    Scaffold(
        ...
        Box {
            ...
            GradientScrim(homeListState, firstItemHeight)
            LazyColumn(
                ...
                item { HomeFavoriteArtistList(favoriteArtists = homeUiState.favoriteArtists) }
                item { HomeFavoriteArtistList(favoriteArtists = homeUiState.favoriteArtists) }
                item { HomeFavoriteArtistList(favoriteArtists = homeUiState.favoriteArtists) }
                item { HomeFavoriteArtistList(favoriteArtists = homeUiState.favoriteArtists) }
                item { HomeFavoriteArtistList(favoriteArtists = homeUiState.favoriteArtists) }
...
@Composable
private fun HomeFavoriteArtistList(favoriteArtists: List<ArtistUiModel>) {
    Column {
        Title(
